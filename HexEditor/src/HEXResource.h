...
#define IDD_OPTION_DLG           20200
	...
	#define IDC_STATIC_FONTNAME					(IDD_OPTION_DLG + 16)
	#define IDC_COMBO_FONTNAME					(IDD_OPTION_DLG + 17)
	#define IDC_STATIC_FONTSIZE					(IDD_OPTION_DLG + 18)
	#define IDC_COMBO_FONTSIZE					(IDD_OPTION_DLG + 19)
	#define IDC_CHECK_BOLD					    (IDD_OPTION_DLG + 20)
	#define IDC_CHECK_ITALIC					(IDD_OPTION_DLG + 21)
	#define IDC_CHECK_UNDERLINE					(IDD_OPTION_DLG + 22)
    #define IDC_STATIC_TXT 	    		        (IDD_OPTION_DLG + 23)
    #define IDC_STATIC_BK 	    		        (IDD_OPTION_DLG + 24)
    #define IDC_STATIC_REGTXT 	    		    (IDD_OPTION_DLG + 25)
    #define IDC_COMBO_REGTXT_TXT 	    		(IDD_OPTION_DLG + 26)
    #define IDC_COMBO_REGTXT_BK  	    		(IDD_OPTION_DLG + 27)
    #define IDC_STATIC_SEL   	    		    (IDD_OPTION_DLG + 28)
    #define IDC_COMBO_SEL_TXT 	    		    (IDD_OPTION_DLG + 29)
    #define IDC_COMBO_SEL_BK  	    		    (IDD_OPTION_DLG + 30)
    #define IDC_STATIC_DIFF   	    		    (IDD_OPTION_DLG + 31)
    #define IDC_COMBO_DIFF_TXT 	    		    (IDD_OPTION_DLG + 32)
    #define IDC_COMBO_DIFF_BK  	    		    (IDD_OPTION_DLG + 33)
    #define IDC_STATIC_BKMK   	    		    (IDD_OPTION_DLG + 34)
    #define IDC_COMBO_BKMK	 	    		    (IDD_OPTION_DLG + 35)
