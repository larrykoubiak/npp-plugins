unit NppScintillaConstants;

(*
  Based on Scintilla.h of version 1.73
  See also http://scintilla.sourceforge.net/ScintillaDoc.html
*)
...
interface
  ...
  type
    RSciCharacterRange = record
      cpMin: integer;
      cpMax: integer;
    end;

    RSciTextRange = record
      chrg: RSciCharacterRange;
      lpstrText: PChar;
    end;

    RSciTextToFind = record
      chrg: RSciCharacterRange;
      lpstrText: PChar;
      chrgText: RSciCharacterRange;
    end;
